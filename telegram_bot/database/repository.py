...
class UserRepository:
    ...
    async def get_or_create(
        ...
        default_project_free_credits: int = 0,
    ) -> tuple[User, bool]:
        ...
        user = User(
            ...
            project_free_credits=default_project_free_credits,
            referral_code=code,
    ...
    async def decrement_project_free_credit(self, user: User) -> None:
        user.project_free_credits = max(0, user.project_free_credits - 1)
        await self.session.commit()
